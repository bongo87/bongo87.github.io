...
3. Interactive Tab Sections
   ...
   - Education: Academic history at North-West University and high school subjects.
   - Certifications: Formal certifications in First Aid and Fire Fighting.
   - Featured Projects: Descriptions and tech stacks of my software and network engineering assignments.
...
- Tailwind CSS: Used for layout styling, dark theme colors, spacing, and responsive screen design.
- JavaScript (ES6): Used for controlling page navigation, switching tabs, and handling mouse wheel scroll events.
- Font Awesome: Used for interface icons.
- GitHub Pages: Used for hosting and deploying the static website online.


File Structure

- index.html: The primary HTML file containing all web sections, styles, and inline JavaScript functionality.
- README.md: Documentation describing the project, setup instructions, and features.



Author Information

- Name: Rebone Motswana
- Program: Bachelor of Science in Information Technology (Final Year)
- Institution: North-West University (NWU), Vanderbijlpark Campus
